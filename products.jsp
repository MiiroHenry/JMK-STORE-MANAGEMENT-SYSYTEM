...
<body>
<table border="1" style="border-radius:50px; width: 50%;color: #BDB76B; border-top: 5px;border-bottom: 5px;border-left: 5px;border-right: 5px; background-color: #2F4F4F" align="center" height="50">
  <th style="border-radius:50px;">
  	<div class="flex-container">
  <div><a href="register1.jsp" class="design"target="blank" style="color: white;">Add Product</a></div>
  <div><a href="payments.jsp" class="design"target="blank"style="color: white;">Remove Product</a></div>
  <div><a href="products.jsp" class="design"target="blank"style="color: white;">View Product Details</a></div>
  <div><a href="sales1.jsp" class="design" target="blank"style="color: white;">Edit Product Details</a></div>
...
<form class="form-style-9" method="post" onsubmit="return validate();" style="border-radius: 50px">
	...
	<p align="center" style=" font-family: Georgia, serif;font-size: 18px;font-weight: bold;color: 	rgb(128,128,128);">Add products</p>
<ul>
<li>
